...
- OpenAI-compatible and Anthropic model adapters with structured output helpers.
...
M1 is implemented through M1-19, including the Anthropic adapter and the
IronBCC OpenAI-compatible Gemma path.
